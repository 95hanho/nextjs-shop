...
export const authServiceDoc = {
	...
	joinUser: async (obj: JoinForm): Promise<AxiosResponse<any>> => await postUrlFormData(API_URL.AUTH_JOIN, obj),
	reToken: async (obj: { refresh_token: string }): Promise<AxiosResponse<any>> => await postUrlFormData(API_URL.AUTH_TOKEN, obj),
};
