...
export const authService_doc = {
	...
	id_duplcheck: async (obj: Partial<JoinForm>): Promise<AxiosResponse<any>> =>
	...
	// 	await get_normal(API_URL.MEMBER_ID, obj),
	join_member: async (obj: JoinForm): Promise<AxiosResponse<any>> =>
		await post_urlFormData(API_URL.MEMBER, obj),
};
