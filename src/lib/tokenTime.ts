...
export const ACCESS_TOKEN_EXPIRES_IN = "5s"; // 5초
export const ACCESS_TOKEN_COOKIE_AGE = 5; // 5초
export const REFRESH_TOKEN_EXPIRES_IN = "3d"; // 3일
export const REFRESH_TOKEN_COOKIE_AGE = 60 * 60 * 24 * 3; // 3일
